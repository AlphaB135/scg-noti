        ...
        <nav className="flex-1 space-y-1 px-2 pb-6 overflow-y-auto">
          <details className="group" open>
            ...
            <div className="ml-4 mt-2 space-y-1">
              ...
              <Link to="/" className="block rounded-md px-3 py-2 hover:bg-white/5 transition-colors">
                ประวัติการดำเนินการ
              </Link>
            </div>
          </details>
          ...
          <div className="flex justify-end gap-2 mb-8">
            <DropdownMenu>
              ...
              <DropdownMenuContent align="end">
                <DropdownMenuItem>ดาวน์โหลดเป็น Excel</DropdownMenuItem>
                <DropdownMenuItem>ดาวน์โหลดเป็น PDF</DropdownMenuItem>
                <DropdownMenuItem>พิมพ์รายงาน</DropdownMenuItem>
              </DropdownMenuContent>
            </DropdownMenu>
          </div>
        </div>
