    ...
    <section className="w-full h-full rounded-[20px] border border-gray-100 bg-white shadow-sm backdrop-blur-sm shadow-xl ring-1 ring-black/5 transition hover:scale-[1.02] duration-300 shadow-md flex flex-col">
      <div className="p-4 md:p-6">
        <div className="flex justify-between items-center mb-3 md:mb-4">
          <h2 className="text-base md:text-lg font-bold text-gray-800">สิ่งที่ต้องทำ</h2>
                    ...
                    .map((task, index) => (
                      ...
                      >
                        ...
                        <div className="flex-1 min-w-0">
                          ...
                          <p className="text-[10px] md:text-xs text-gray-500 truncate">{task.details}</p>
                          <div className="flex justify-between items-center mt-1">
                            <span className="text-[10px] md:text-xs text-gray-500 flex items-center gap-1">
                              <Calendar className="h-3 w-3 md:h-3.5 md:w-3.5" /> กำหนด: {task.dueDate}
                            </span>
                  ...
                  {tasks
                    ...
                    .map((task, index) => (
                      ...
                      >
                        ...
                        <div className="flex-1 min-w-0">
                          <div className="flex justify-between items-start">
                            <p className="text-xs md:text-sm font-medium line-through text-gray-400">{task.title}</p>
                          ...
                          <p className="text-[10px] md:text-xs text-gray-400 line-through">{task.details}</p>
                          <div className="flex justify-between items-center mt-1">
